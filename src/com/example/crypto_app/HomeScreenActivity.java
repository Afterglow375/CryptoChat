...
public class HomeScreenActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.homescreen_list_item, R.id.sampleText, SAMPLE);
		
		setListAdapter(new ArrayAdapter<String>(this, R.layout.activity_home_screen, SAMPLE));
